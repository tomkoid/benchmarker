...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (compared > 0) {
        if (score1 > score2) {
            summary = `<div style="background:#e6ffe6;border-radius:10px;padding:18px 20px;margin:30px auto 0;max-width:700px;font-size:1.18em;color:#1a4d1a;text-align:center;font-weight:bold;">${prod1.name} má lepší parametry v ${score1} z ${compared} případů.</div>`;
        } else if (score2 > score1) {
            summary = `<div style="background:#e6ffe6;border-radius:10px;padding:18px 20px;margin:30px auto 0;max-width:700px;font-size:1.18em;color:#1a4d1a;text-align:center;font-weight:bold;">${prod2.name} má lepší parametry v ${score2} z ${compared} případů.</div>`;
        } else {
            summary = `<div style="background:#fffbe6;border-radius:10px;padding:18px 20px;margin:30px auto 0;max-width:700px;font-size:1.18em;color:#665c00;text-align:center;font-weight:bold;">Oba produkty mají stejný počet lepších parametrů (${score1} z ${compared}).</div>`;
        }
    }
